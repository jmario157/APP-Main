...
import ModalInformacionBloque from "./modalInformacionBloque";
function ModalBloqueForm({ accion, datosBloque, ActualizarTabla, datosProyectos, datosEtapas }) {
  ...
  return (
    <>
      ...
      <ModalInformacionBloque datos={datosBloque} showModal={showModalInformacion} setShowModalInformacion={setShowModalInformacion}></ModalInformacionBloque>
    </>
  );
}

export default ModalBloqueForm;
