...
const ModalInformacionBloque = ({ datos, showModal, setShowModalInformacion }) => {
  return (
    <Modal
      show={showModal}
          ...
          <div className="card card-widget widget-user shadow">
            ...
            <div className="card-body">
              ...
              <p className="text-muted">
                {datos?datos.etapa.proyecto.nombre:""}
              </p>
              <hr></hr>
              <strong><i className="fas fa-map-marker-alt mr-1"></i> Etapa</strong>
              <p className="text-muted">
                {datos?datos.etapa.nombre:""}
              </p>
              <hr></hr>
...
export default ModalInformacionBloque;
