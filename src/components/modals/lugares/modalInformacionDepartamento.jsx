...
const ModalInformacionDepartamento = ({ datos, showModal, setShowModalInformacion }) => {
  return (
    <Modal
      show={showModal}
          ...
          <div className="card card-widget widget-user shadow">
            ...
            <div className="card-body">
              ...
              <p className="text-muted">
                {datos?datos.pai.nombre:""}
              </p>
              <hr></hr>
              <strong><i className="fas fa-map-marker-alt mr-1"></i> Codigo</strong>
              <p className="text-muted">
                {datos?datos.numero:""}
              </p>
            </div>
...
export default ModalInformacionDepartamento;
