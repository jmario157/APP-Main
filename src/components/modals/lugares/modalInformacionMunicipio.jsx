...
const ModalInformacionMunicipio = ({ datos, showModal, setShowModalInformacion }) => {
  return (
    <Modal
      show={showModal}
          ...
          <div className="card card-widget widget-user shadow">
            ...
            <div className="card-body">
              ...
              <p className="text-muted">
                {datos?datos.departamento.nombre:""}
              </p>
              <hr></hr>
              <strong><i className="fas fa-map-marker-alt mr-1"></i> Pais</strong>
              <p className="text-muted">
                {datos?datos.departamento.pai.nombre:""}
              </p>
            </div>
          </div>
        </div>
...
export default ModalInformacionMunicipio;
